...
const imageData = [
  {
    ...
    // image: "/wild1.jpeg",
    paragraphs: [
      "1) Greeting Namaste. Pickup from Bangalore","(9:30pm-10:00pm Shantala Silks Famous Trekking Pickup Spot)","(10:30pm-11:00pm Goraguntepalya near metro station)","2) Start journey towards Durgadahalli."
    ]
  },
  {
    title: "Day 1",
    ...
    paragraphs: [
      ...
      "8) Reach first point @ 11:30 AM.","9) Start trek towards bandaje falls after a quick relief @ 11:45 AM.","10) Pushing All Limits to Reach Bandaje Arbi waterfalls @ 12:30 PM.","11) Enjoying the Marvelous Creation of Western Ghats and waterfall as far as our Eyes can Stretch and have packed lunch with the view.","12) Starting to Hike back our journey towards base point @ 14:00 hours.","13) Cherishing Golden Hour Sunset @ 15:00 hours and Coming back to the base point by 18:30 hours.","14) Reach Tent camp site / homestay have a coffee and snack break.","15) After Refreshing,starting the Campfire @ 19:30 hours onwards.","16) Some Group Games and Group Conversations while Bonfires.","17) Savouring Delicious Dinner @ 21:00 hours.","18) Goodnight at @ 22:00 Hours."
    ]
  }, {
    title: "Day 2",
    image: "/bandaje3.jpg",
...
useEffect(() => {
  axios.get(`${API_BASE_URL}/api/rappelling/dates?activity=Bandaje Falls Trek`)
    .then((res) => {
...
useEffect(() => {
  refreshDates();
  axios.get(`${API_BASE_URL}/api/rappelling/price?activity=Bandaje Falls Trek`)
    .then(res => {
...
const handleDelete = (id) => {
  axios.delete(`${API_BASE_URL}/api/rappelling/dates/${id}?activity=Bandaje Falls Trek`)
    .then(() => {
      refreshDates();
    });
};
...
const handleCollapseAll = () => {
  ...
  return (
    <div className="rappelling-wrapper">
      <NavbarTrip/>
      <img className="main-image" src="/bandaje.jpg" alt="Bandaje Falls Trek" />
 <div className="rappelling-content-wrapper">
      <div className="rappelling-page">
        <div className="content">
          <h1>Bandaje Falls Trek
</h1>
          <div className="info">
  ...
  <div className="section-separator"></div>
    ...
    <div className="activity-details">
                <div><strong><LuClock4/>  Duration:</strong> 2 Day 1 Night</div>
          ...
          <p>Bandaje falls trek is an Exciting Combination of Archaic Fort residing at an High Altitude and A Trek through Shola Green Forests to Explore a Magnificent 1000ft tall Plunging Bandaje Waterfall is Definite to Thrill you with the Emblazoned Hues of Nature,</p>

          <p>As the Trek Comprises of 4 Terrains in a Single day, Starting from Initial Densely Deciduous Jungles and as We Gear up our Trek, We Come out of the Canopy and Open ourselves to High Altitudes of Lush Greenery, Each and Every Segment of this Journey Encompasses with Visual Delights as the Clouds Traverse besides us and Windprone Areas Leave us Spellbound with its Impulse.</p>

          <p>Finally the Trails of the Trek is Set up to Converge the Streams of Mountain Waters that Take a Plunge from the Cliff and Unveil a Grand Valley that Serves a Visual Delight and Serendipity to our Mind.</p>
  ...
  <div className="section-separator"></div>
          ...
          <div className="included">
            ...
            <p>✅ guide charges.</p>
            <p>✅ 2 breakfast, 1 packed lunch and 1 dinner (Malnad style cuisine).</p>
