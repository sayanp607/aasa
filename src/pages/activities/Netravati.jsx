...
useEffect(() => {
  axios.get(`${API_BASE_URL}/api/rappelling/dates?activity=Netravati Trek`)
    .then((res) => {
...
useEffect(() => {
  refreshDates();
  axios.get(`${API_BASE_URL}/api/rappelling/price?activity=Netravati Trek`)
    .then(res => {
...
const imageData = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "6:30 PM: Tea & snacks","7:30 PM: Campfire","9:00 PM: Dinner"
    ]
  }, {
    title: "Day 2",
...
const handleDelete = (id) => {
  axios.delete(`${API_BASE_URL}/api/rappelling/dates/${id}?activity=Netravati Trek`)
    .then(() => {
      refreshDates();
    });
};
...
const handleCollapseAll = () => {
  ...
  return (
    <div className="rappelling-wrapper">
      <NavbarTrip/>
      <img className="main-image" src="/netravati.jpg" alt="Netravati Trek: Experience the Beauty of the Western Ghats" />
 <div className="rappelling-content-wrapper">
      <div className="rappelling-page">
        <div className="content">
          <h1>Netravati Trek: Experience the Beauty of the Western Ghats
</h1>
          <div className="info">
...
<div className="activity-details">
            <div><strong><LuClock4/>  Duration:</strong> 2 Days</div>
          ...
          <p>The Netravati Trek is a captivating journey for nature lovers and adventure enthusiasts alike. Located in the scenic valley, this trek offers an unforgettable experience filled with lush greenery, pristine river views, and diverse wildlife. Whether you’re a seasoned trekker or new to hiking, Netravati Trek provides an adventure that’s both exhilarating and serene.</p>

          <h2>Introduction to Netravati Trek</h2>
          <p>The Netravati River, flowing through the Western Ghats, carves a beautiful valley, making it a perfect destination for trekking. The trek is known for its challenging yet rewarding trails that offer panoramic views of the valley, making it a must-do for adventure seekers. Rich in flora and fauna, the region is a biodiversity hotspot, and the trek allows you to immerse yourself in nature.</p>

          <h2>Exploring the Netravati River Valley</h2>
          <p>The Netravati River Valley is one of the most scenic landscapes in southern India. Trekking here means walking through dense forests, crossing streams, and discovering hidden waterfalls. The valley’s beauty is enhanced by its vibrant birdlife and the occasional sighting of wildlife. Every turn in the trail offers something new, from mist-covered hills to picturesque river views.</p>

          <h2>Best Time for Netravati Trek</h2>
          <p>The ideal time for the Netravati Trek is during the post-monsoon and winter seasons, from September to February. During this period, the weather is cool, and the region’s flora is at its most vibrant. The river flows in full force, and the trails are in perfect condition for trekking. Avoid the trek during the monsoon season, as the trails can become slippery and dangerous.</p>

          <h2>Essential Tips for Netravati Trekkers</h2>
          <p>Before embarking on the Netravati Trek, ensure you are well-prepared. Wear comfortable trekking shoes with good grip, carry enough water and snacks, and pack light layers to adapt to changing weather. It’s advisable to trek with a guide or in a group, especially if you’re unfamiliar with the terrain.</p>

          <h2>Conclusion</h2>
          <p>The Netravati Trek is an adventure that promises stunning views, challenging trails, and a chance to reconnect with nature. Whether you’re exploring the valley’s rich biodiversity or soaking in the tranquil river scenes, this trek offers a memorable experience for anyone seeking an escape into the wild. Plan your trek today and discover the gems!</p>

          <h2>Highlights</h2>
          <ul>
            <li>Crisscrossing Streams, Hiking up the Velvety Grasslands, Soaking up in the Waterfalls then Climbing the Mountains above the Cloud.</li>
  ...
  <div className="section-separator"></div>
          ...
          <div className="included">
            ...
            <p>✅ Private Transport: To Samse Base Camp & scenic viewpoints</p>
            <p>✅ Entry Fees: Forest Entry ₹500</p>
            <p>✅ Guided Trek: Includes local expert</p>
            <p>✅ Meals: 2 Breakfasts, 1 Packed Lunch, 1 Dinner (authentic Malnad cuisine)</p>
