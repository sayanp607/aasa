...
const Malenadu = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_BASE_URL}/api/rappelling/dates?activity=MONSOONS IN MALENADU`)
      .then((res) => {
  ...
  useEffect(() => {
    refreshDates();
    axios
      .get(`${API_BASE_URL}/api/rappelling/price?activity=MONSOONS IN MALENADU`)
      .then((res) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete(
        `${API_BASE_URL}/api/rappelling/dates/${id}?activity=MONSOONS IN MALENADU`,
      )
      .then(() => {
        refreshDates();
      });
  ...
  return (
    <div className="rappelling-wrapper">
      ...
      <img
        ...
        src="https://images.unsplash.com/photo-1501555088652-021faa106b9b?auto=format&fit=crop&q=80&w=2400"
        alt="MONSOONS IN MALENADU
"
      />
      <div className="rappelling-content-wrapper">
        <div className="rappelling-page">
          <div className="content">
            <h1>MONSOONS IN MALENADU</h1>
            <div className="info">
              <p>
            ...
            <h2>Overview</h2>
            <p>
              Experience the breathtaking magic of monsoon in Sirsi with Team
              Highhawks !{" "}
            </p>

            <p>
              Embark on an exhilarating trek through lush green landscapes,
              where the rain-kissed paddy fields stretch as far as the eye can
              see. As you navigate the enchanting trails, be prepared to be
              awestruck by the mesmerizing waterfall views that cascade down the
              mountains, creating a symphony of nature’s beauty. Feel the mist
              on your skin and let the rhythmic sound of the falling water
              rejuvenate your senses.
            </p>

            <p>
              But the adventure doesn’t stop there! Engage in thrilling games
              amidst the scenic backdrop of Malenadu. Test your agility and
              conquer the challenging terrain while bonding with your fellow
              trekkers. Whether it’s a friendly race or a team-building
              activity, the rain-soaked paddy fields provide the perfect
              playground for unforgettable moments of fun and excitement.
              <p>
                And when it comes to satisfying your taste buds, Malenadu
                cuisine is an absolute delight. Indulge in a gastronomic journey
                as you savor authentic local delicacies prepared with fresh
                ingredients sourced from the bountiful region. From aromatic
                spices to rich flavors, each bite will transport you to a world
                of culinary bliss.
              </p>
              <p>
                So, join Team Highhawks as we unravel the wonders of monsoon in
                Sirsi. Discover the allure of waterfall views, embrace the joy
                of paddy field games, and relish the tantalizing flavors of
                Malenadu cuisine. This is a journey you don’t want to miss!{" "}
              </p>
            </p>
