...
useEffect(() => {
  axios.get(`${API_BASE_URL}/api/rappelling/dates?activity=Waterfall Rappelling`)
    .then((res) => {
...
useEffect(() => {
  refreshDates();
  axios.get(`${API_BASE_URL}/api/rappelling/price?activity=Waterfall Rappelling`)
    .then(res => {
...
const handleUpdate = (id) => {
  axios.put(`${API_BASE_URL}/api/rappelling/dates/${id}`, {
    activity: "Waterfall Rappelling",
    date: newDate,
    price: newPrice
  }).then(() => {
...
const handleDelete = (id) => {
  axios.delete(`${API_BASE_URL}/api/rappelling/dates/${id}?activity=Waterfall Rappelling`)
    .then(() => {
      refreshDates();
    });
};
...
const handleCollapseAll = () => {
  ...
  return (
    <div className="rappelling-wrapper">
      <NavbarTrip/>
      <img className="main-image" src="/waterfall.jpg" alt="Waterfall Rappelling" />
 <div className="rappelling-content-wrapper">
  ...
  <div className="activity-details">
          ...
          <p><strong>Checkout what people say:</strong> google review ⭐⭐⭐⭐⭐</p>

          <h2>What is Waterfall Rappelling?</h2>
          <p>Waterfall rappelling, also known as abseiling, is a heart-racing ...</p>
